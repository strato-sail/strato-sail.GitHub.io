...
- 在官网`github`中下载`dubbo-admain`，我所下版本的[源码](https://github.com/strato-sail/strato-sail.GitHub.io/tree/main/_posts/dubbo)。
...
在服务提供者和服务消费者的`pom`文件里添加如下依赖（注意，添加依赖前先将接口工程使用 maven install ）：
